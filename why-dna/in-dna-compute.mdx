...
<CardGroup cols={2}>
  <Card title="Select" icon="filter">
    ...
    via recursive selective PCR — after *m* steps only identifiers containing
    the full key remain enriched.
  </Card>
...
<Steps>
  ...
  <Step title="Sequence the enriched subset">
    ...
    high signal-to-noise ratio — reading orders of magnitude fewer molecules
    than a full scan.
  </Step>
</Steps>
